    ...
    return (
        <AppLayout>
            ...
            <div className="min-h-screen bg-white px-4 py-10 dark:bg-gray-800">
                <h1 className="mb-6 text-center text-4xl font-extrabold text-gray-900 dark:text-white">Pista de Empleados</h1>
                ...
                {activityMatrix.length === 0 ? (
                    <div className="text-center text-lg text-gray-500 dark:text-gray-400">No se encontraron acciones para esta fecha.</div>
                ) : (
