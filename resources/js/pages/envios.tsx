        ...
        <AppLayout>
            ...
            <div className="min-h-screen bg-gray-50 px-4 py-10 font-sans dark:bg-gray-900">
                <div className="mb-8 text-center">
                    <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-100">Gestión de Repuestos: {vehiculo.modelo}</h1>
                ...
                <div className="mx-auto max-w-5xl space-y-8">
                    ...
                    <div className="space-y-6">
                        <h2 className="px-2 text-xl font-bold text-gray-800 dark:text-white">Historial de Solicitudes</h2>
                                ...
                                <div className="mb-4 rounded-full bg-gray-100 p-3 dark:bg-gray-700">
                                    ...
                                    >
                                        <path
                                            ...
                                            d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5m8.25 3.75h3.75M12 11.25h-3.75m-4.5-3.75h16.5"
                                        />
                                    </svg>
                                </div>
                ...
                {imagenModal && (
                    ...
                    >
                        <div className="relative max-w-5xl duration-200 animate-in zoom-in-95">
                            <button
                                className="absolute -top-4 -right-4 z-10 rounded-full bg-white p-2 text-gray-900 shadow-lg hover:bg-gray-100"
                                onClick={() => setImagenModal(null)}
                            >
...
const EnvioCard = ({
    ...
    const cambiarEstado = (nuevoEstado: string) => {
        ...
        setProcesando(true);
        router.post(
            `/fichaTecnica/${vehiculoPlaca}/envios/${envio.id}`,
            {
                _method: 'POST',
                estado: nuevoEstado,
    ...
    const config = {
        ...
        en_camino: {
            color: 'bg-blue-500',
            badge: 'bg-blue-100 text-blue-800 ring-blue-700/10',
            text: 'En Camino',
            icon: (
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        recibido: {
            color: 'bg-[#49af4e]',
            badge: 'bg-[#49af4e]/10 text-[#49af4e] ring-[#49af4e]/20',
            text: 'Completado',
            icon: (
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    return (
        <div className="group relative flex flex-col gap-6 overflow-hidden rounded-xl border border-gray-200 bg-white p-6 shadow-md transition-all duration-300 hover:shadow-lg dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className={`absolute top-0 left-0 h-full w-1.5 ${currentConfig.color}`} />
            ...
            <div className="flex flex-col gap-4">
                <div className="flex flex-col justify-between sm:flex-row sm:items-center">
                    <div className="flex flex-col gap-1">
                        ...
                        <span
                            className={`inline-flex w-fit items-center gap-1.5 rounded-full px-3 py-1 text-xs font-semibold ring-1 ${currentConfig.badge}`}
                        >
                            {currentConfig.icon}
                            {currentConfig.text}
                        </span>
                        ...
                        {isAdmin && envio.estado === 'pendiente' && !mostrarInput && (
                            <>
                                ...
                                <button
                                    ...
                                    className="rounded-lg border border-gray-300 bg-white px-4 py-1.5 text-xs font-semibold text-gray-700 shadow-sm transition-transform hover:bg-gray-50 active:scale-95 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200"
                                >
                                    Rechazar
                                </button>
                            </>
                        ...
                        <div className="rounded-xl border border-dashed border-gray-300 bg-gray-50 p-4 dark:border-gray-600 dark:bg-gray-800/50">
                            ...
                            <div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center">
                                <input
                                    ...
                                    className="block w-full cursor-pointer text-xs text-gray-500 file:mr-4 file:cursor-pointer file:rounded-full file:border-0 file:bg-[#49af4e] file:px-4 file:py-2 file:text-xs file:font-semibold file:text-white hover:file:bg-[#3d9641]"
                                />
                            ...
                            <div className="mt-4 flex justify-end gap-2">
                                <button
                                    ...
                                    className="rounded-lg px-3 py-1.5 text-xs font-medium text-gray-600 transition hover:bg-gray-200 hover:text-gray-800 dark:text-gray-400"
                                >
                                    Cancelar
                                </button>
                                <button
                                    ...
                                    className="flex items-center gap-2 rounded-lg bg-[#49af4e] px-4 py-1.5 text-xs font-bold text-white shadow-sm transition-transform hover:bg-[#3d9641] active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
                                >
