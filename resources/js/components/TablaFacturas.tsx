import { FacturaModalData, FacturaShowProps, Renglon, TablaFacturasProps } from '@/types';
...
export function TablaFacturas({ facturas, vehiculo, isAdmin }: TablaFacturasProps) {
