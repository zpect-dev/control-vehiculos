...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('fichaTecnica/{placa}/accesorios', [AccesorioController::class, 'store'])->name('accesorios.store');
    ...
    // RevisionFluidos
    Route::get('revisionFluidos', [RevisionDiariaController::class, 'index'])->name('revisionFluidos');
    Route::post('revisionFluidos/{placa}', [RevisionDiariaController::class, 'store'])->name('revisionFluidos.store');

    // RevisionSemanal
    Route::get('revisionSemanal', [RevisionSemanalController::class, 'index'])->name('revisionSemanal');
    Route::post('revisionSemanal/{placa}', [RevisionSemanalController::class, 'store'])->name('revisionSemanal.store');
});
